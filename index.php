...
<body>
        ...
        <nav class="navbar-container container">
            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                <ul class="navbar-links">
                    <li class="navbar-item"><a class="navbar-link" href="#home1">Home</a></li>
                    ...
                    <li class="navbar-item"><a href="login_form.php" class="navbar-link"style="background-color:#ff4d30 ; border-radius: 0;color :#fff">login</a></li>
                    <li class="navbar-item"><a href="register_form.php" class="navbar-link" style="background-color:black ; border-radius: 0;color :#fff" >register</a></li>
                </ul>
            </div>
        </nav>
    </header>
            ...
            <div class="hero-content">
                <div class="hero-content__text">
                    ...
                    <p>Rent the car of your dreams. Unbeatable prices, unlimited miles, flexible pick-up options and
                        much more.</p>
                    <div class="hero-content__text__btns"><a class="hero-content__text__btns__book-ride" href="login_form.php">Book
   ...
   <section class="slider-container">
        <div class="slider-slide active">
            <img src="creta.jpg" alt="Car Model 1" class="carimage" >
            <div class="slider-content">
                <h2>Creata</h2>
                <p>Experience luxury and performance with our premium car rental service.</p>
                <a class="price">Price-$500/day</a><a href="#" class="booknow">Book Now</a>
            </div>
        </div>
        <div class="slider-slide">
            <img src="ecosport.png" alt="Car Model 2">
            <div class="slider-content">
                <h2>Ecosport</h2>
                <p>Sleek design and advanced technology for your ultimate driving experience.</p>
                <a class="price">Price-$400/day</a><a href="#" class="booknow">Book Now</a>
            </div>
        </div>
        <div class="slider-slide">
            <img src="audi.jpg" alt="Car Model 3">
            <div class="slider-content">
                <h2>Audi</h2>
                <p>Efficiency meets style in our eco-friendly car rental options.</p>
                <a class="price">Price-$900/day</a><a href="#" class="booknow">Book Now</a>
            </div>
        </div>
        <div class="slider-slide">
            <img src="mcec.jpg" alt="Car Model 3">
            <div class="slider-content">
                <h2>BENZ</h2>
                <p>Efficiency meets style in our eco-friendly car rental options.</p>
                <a class="price">Price-$1000/day</a><a href="#" class="booknow">Book Now</a>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer-content">
                <ul class="footer-content__1">
                    ...
                    <li><a href="mailto:  addmail@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="24"
